...
namespace EpocData.MBM
{
    ...
    public class MbmPaintDataSection : IImage
    {
        private uint length;
...
//                unusedPixels = 0;
                ...
                if (fmt == PixelFormat.Format8bppIndexed)
                {
                    if (this.imageIsColor)
                        _bitmap.Palette = MbmPaintDataSection.Palette8Color;
                    else
                        _bitmap.Palette = MbmPaintDataSection.Palette8BW;
                }
...
//                            Debug.WriteLine( xSize );
        ...
        public MbmPaintDataSection(BinaryReader br)
        {
