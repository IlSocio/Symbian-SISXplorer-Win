...
/*                case 0x0003:
                    {                        
                        return "visibility='" + ReadString(br) + "'";
                    }*/
                case 0x0004:
                    {
...
//                        if (r == -100) s = "auto";
    ...
    * ref(svg [, <x>, <y>])
                ...
                case 0x004A:
                    {
                        Debug.Assert(false, "TODO:");
                        return " "; // attributeName='" + ReadString(br) + "'";
                    }
...
//                        return "xmlns='http://www.w3.org/2000/svg' version='" + s + "'";
                ...
                case 0x0067:
                    {
                        return "xlink:actuate='" + ReadString(br) + "'";
                    }
                case 0x0068:
                    {
                        return "xlink:arcrole='" + ReadString(br) + "'";
                    }
                case 0x0069:
                    {
                        return "xlink:role='" + ReadString(br) + "'";
                    }
                case 0x006A:
                    {
                        return "xlink:show='" + ReadString(br) + "'";
                    }
                case 0x006B:
                    {
                ...
                case 0x007B:
                    {
                        ...
                        string d5 = ReadFloat(br).ToString();
                        string d6 = ReadFloat(br).ToString();
//                        br.ReadBytes(4);
...
//                    Debug.WriteLine(s);
        ...
        private string FactoryElements(BinaryReader br)
        {
            ...
            string val = String.Format("{0:X4}", id);
            Debug.Assert(false, "Unsupported TAG Offset:" + err + "   Value:"+val + "   CurrTag:"+currentTag);
        ...
        private string ReverseElements(BinaryReader br)
        {
...
//                    Debug.WriteLine("<"+element+">");
                    stack.Push(element);
                    ris = ris + "<" + element + " " + ReverseAttribs(br) + " >\r\n";
                }
                else
                {
                    if (stack.Count > 0)
        ...
        public string DoReversingJob(BinaryReader br)
        {
            ...
            s += "<!-- Generated from SISXplorer 2.0 -->\r\n";
            s += ReverseElements(br);
            return s;
        }
